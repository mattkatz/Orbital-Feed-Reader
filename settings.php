<div id="orbital_settings">
    ...
    <p>You can <a href="<?php echo site_url("?export_opml=".get_current_user_id())  ?>">export your feed list in OPML format<img id="orbital-opml-icon" class="orbital-opml-icon" width=10 height=10 src="<?php echo plugins_url("img/opml-icon.svg", __FILE__); ?>"/></a> at any time. If you are logged in, you'll get your <b>private</b> feeds in there. If you aren't logged in, the same link will filter out private feeds. This is useful if you want to move your list to another feed reader. </p>
